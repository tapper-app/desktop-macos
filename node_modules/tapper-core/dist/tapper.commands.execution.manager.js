...
export class TapperCommandsExecutionManager {
    static onExecuteCommand(command) {
    ...
    static onExecuteCommandWithAttributes(command, attributes) {
        if (command === TapperCommandsManager.EXECUTE_AUTO_FLOW_TESTING_COMMAND) {
            this.onExecuteAutoTestingFlow();
            return;
        }
    ...
    static async onExecuteAutoTestingFlow() {
    ...
    static async onExecuteNativeAndroidMonkeyTesting() {
    ...
    static onPrintHelpCommandsExamples() {
        console.log("");
